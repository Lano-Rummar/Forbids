    ...
    <div class="row">
      <div class="col-sm-7 col-10">
        <p>Copyright &copy; <script>
          ...
          </script> Kelompok 7 Teknologi Rekayasa Internet B. All Rights Reserved</p>
      </div>
    </div>
  </div>
</footer><!------- Footer Here ------->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row no-margin form-row">
            ...
            <div class="col-sm-8">
              <button onclick="account_signup()" class="btn w-100 btn-danger btn-sm">Dont have Account Signup</button>
            </div>
          </div>
        </div>
